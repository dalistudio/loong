...
# 修改产品名称
sed -i '/AC_INIT/s/memcached/jiaotu/' ./memcached-1.4.20/configure.ac
sed -i '/memcached@googlegroups.com/s/memcached/jiaotu/' ./memcached-1.4.20/configure.ac
...
# 修改默认设置
sed -i '/settings.port = 11211;/s/11211/6000/' ./memcached-1.4.20/memcached.c
sed -i '/settings.udpport = 11211;/s/11211/6000/' ./memcached-1.4.20/memcached.c
## 需要转意 * 符号，使用 \* 表示 *
